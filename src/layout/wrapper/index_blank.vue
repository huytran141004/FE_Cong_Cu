...
<script>
import TopVuexy from "../components/Client/TopClient.vue";
import MenuVuexy from "../components/Client/MenuClient.vue";
import BotVuexy from "../components/Client/BotClient.vue";
