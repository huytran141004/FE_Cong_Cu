...
<script>
import TopVuexy from "../../layout/components/Client/TopClient.vue";
import MenuVuexy from "../../layout/components/Client/MenuClient.vue";
import BotVuexy from "../../layout/components/Client/BotClient.vue";
