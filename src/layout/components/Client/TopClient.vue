            ...
            <nav class="navbar navbar-expand">
                <div class="topbar-logo-header">
                    <div>
                        <img src="https://tse2.mm.bing.net/th?id=OIP.-UOUT22rz3P5SGjRfS1TigHaEE&pid=Api&P=0&h=220"
                            style="width: 100px;" class="logo-icon img-fluid" alt="logo icon">
                    </div>
                </div>
                <div class="mobile-toggle-menu"><i class='bx bx-menu'></i></div>
                <div class="search-bar flex-grow-1 text-center">
                    <h1>Trung Tâm Hồ Bơi</h1>
                </div>
                ...
                <div class="user-box dropdown">
                    <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <img src="https://tse3.mm.bing.net/th?id=OIP.cS2qy9i26av0okIMpmZ7pQHaHa&pid=Api&P=0&h=220"
